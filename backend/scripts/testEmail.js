...
const recipient = String(process.env.EMAIL_TEST_TO || process.env.EMAIL_USER || "").trim();

if (!recipient) {
  console.error("Set EMAIL_TEST_TO (or EMAIL_USER) before running the email test.");
  process.exit(1);
}
